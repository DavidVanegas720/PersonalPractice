...
class User:
    ...
    def save(cls, formulario):
        ...
        result = connectToMySQL('muroprivado_g1').query_db(query, formulario) #1 - Insert recibe id
    ...
    def get_by_id(cls, formulario):
        ...
        result = connectToMySQL('muroprivado_g1').query_db(query, formulario) #Select recibe lista
        user = cls(result[0])
        return user
    ...
    def get_all(cls):
        ...
        results = connectToMySQL('muroprivado_g1').query_db(query) #lista de diccionarios
        #results = [
        #    {id: 1, first_name: elena,.......},
        #    {id: 2, first_name: juana,.......}
        #]
        users = [] #Lista vacía de usuarios
        for user in results:
            users.append(cls(user)) #1.- cls(user) crea una instancia de usuario basado en el diccionario; 2.- agrego esa instancia a la lista de users
        return users